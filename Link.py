...
class Link:
    ...
    def __init__(self, terminals, prevLayerN, threshold1, tau1, timeStep):
        ...
        wMin = (self.v * self.tau)/(terminals*prevLayerN*self.lifFunction(timeStep))
        wMax = (self.v * self.tau)/(terminals*prevLayerN*self.lifFunction(tmax))
